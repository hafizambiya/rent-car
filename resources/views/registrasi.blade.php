      ...
      <div class="card z-index-0">
        ...
        <div class="card-body">
          <form enctype="multipart/form-data" method="post" action="{{ url('registrasi_proses') }}">
            ...
            <div class="mb-3">
                <input type="Number" class="form-control" placeholder="No Telepon" aria-label="Alamat" name="no_hp">
              </div>
              @error('no_hp')
                <p class="text-danger">{{ $message }}</p>
            @enderror
              ...
              <div class="mb-3">
                <input type="text" class="form-control" placeholder="SIM" aria-label="Alamat" name="sim">
              </div>
              @error('sim')
              <p class="text-danger">{{ $message }}</p>
          @enderror
